...
ActiveRecord::Schema.define(version: 20180830113658) do
  ...
  create_table "account_accesses", force: :cascade do |t|
    ...
    t.index ["user_id"], name: "index_account_accesses_on_user_id"
  end
  ...
  create_table "apps", force: :cascade do |t|
    ...
    t.integer "user_id"
    t.string "openid_client_id"
    t.string "openid_client_secret"
    t.string "openid_redirect_urls"
    t.string "openid_client_access_token"
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.string "openid_access_token"
    t.string "openid_id_token"
