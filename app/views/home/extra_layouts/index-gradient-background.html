...
<html class="no-js" lang="en">
    ...
    <body class="light-header animsition">
        ...
        <!-- ========== HEADER ========== -->
        <header class="header main-header gradient-bg" >
            <div class="container">
            ...
            <div class="container feature-desc">
                <div class="row">
                    ...
                    <div class="col-md-6 col-md-offset-1 pull-right">
                        <img src="http://placehold.it/1600x1100?text=SoftEase" alt="" class="img-responsive">
                    </div>

                    <div class="col-md-5">
                        <h2 class="mtn">This is amazing dashboard</h2>
